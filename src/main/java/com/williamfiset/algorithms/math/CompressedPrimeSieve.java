 ...
 * src/main/java/com/anzal/algorithms/math/CompressedPrimeSieve.java
 *
 * <p>Run: java -cp src/main/java com/anzal/algorithms/math/CompressedPrimeSieve
 *
 * @author anzal
 */
package com.anzal.algorithms.math;
