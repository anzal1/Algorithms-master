 ...
 * src/main/java/com/anzal/algorithms/strings/LongestCommonSubstring.java
 *
 * <p>Run: $ java -cp src/main/java com/anzal/algorithms/strings/LongestCommonSubstring
 *
 * @author anzal
 */
package com.anzal.algorithms.strings;
...
public class LongestCommonSubstring {
  ...
  public static class LcsSolver {
    ...
    // TODO(anzal): support LCS with strings as int arrays for larger alphabet sizes.
    ...
    private boolean enoughUniqueColorsInWindow(int lo, int hi) {
      // TODO(anzal): Avoid initializing a new hash set to count colors every method call.
      Set<Integer> set = new HashSet<>();
      for (int i = lo; i <= hi; i++) {
        set.add(imap[sa[i]]);
      }
      // TODO(anzal): Investigate if == can become >=
      return set.size() == k;
    }
    ...
    private void solve() {
      ...
      // TODO(anzal): Replace with SlidingWindowMinimum for speed.
