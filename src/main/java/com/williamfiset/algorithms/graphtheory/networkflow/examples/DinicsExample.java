 ...
 * src/main/java/com/anzal/algorithms/graphtheory/networkflow/examples/DinicsExample.java
 *
 * <p>Run: $ java -cp src/main/java
 * com/anzal/algorithms/graphtheory/networkflow/examples/DinicsExample
 */
