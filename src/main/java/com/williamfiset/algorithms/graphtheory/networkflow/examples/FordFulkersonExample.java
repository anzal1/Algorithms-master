 ...
 * src/main/java/com/anzal/algorithms/graphtheory/networkflow/examples/FordFulkersonExample.java
 *
 * <p>Run: $ java -cp src/main/java
 * com/anzal/algorithms/graphtheory/networkflow/examples/FordFulkersonExample
 */
