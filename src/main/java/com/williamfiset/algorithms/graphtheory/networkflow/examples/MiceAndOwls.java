/**
 * Download the code: $ git clone https://github.com/anzal/Algorithms
 *
 * <p>Change directory to the root of the Algorithms directory: $ cd Algorithms
 *
 * <p>Build: $ javac -d src/main/java
 * src/main/java/com/anzal/algorithms/graphtheory/networkflow/examples/MiceAndOwls.java
 *
 * <p>Run: $ java -cp src/main/java
 * com/anzal/algorithms/graphtheory/networkflow/examples/MiceAndOwls
 */
